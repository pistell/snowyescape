function volumeUpFire() {
    var e = $(".audio-fire").prop("volume") + .05;
    e > 1 && (e = 1), $(".audio-fire").prop("volume", e), updateFire(e)
}

function volumeDownFire() {
    var e = $(".audio-fire").prop("volume") - .05;
    0 > e && (e = 0), $(".audio-fire").prop("volume", e), updateFire(e)
}

function volumeUpWind() {
    var e = $(".audio-wind").prop("volume") + .05;
    e > 1 && (e = 1), $(".audio-wind").prop("volume", e), updateWind(e)
}

function volumeDownWind() {
    var e = $(".audio-wind").prop("volume") - .05;
    0 > e && (e = 0), $(".audio-wind").prop("volume", e), updateWind(e)
}

function updateWind(e) {
    e = Math.round(100 * e), $(".value-wind").html(e), seSnowVolume = e, watchSnowVolume()
}

function updateFire(e) {
    e = Math.round(100 * e), $(".value-fire").html(e), seFireVolume = e, watchFireVolume()
}

function watchSnowVolume() {
    var e = seSnowVolume;
    setTimeout(function () {
        e == seSnowVolume ? ga("send", "event", "Volume-Beta", "updated", "Snow volume at " + seSnowVolume) : e = seSnowVolume
    }, 3e3)
}
...
function watchFireVolume() {
    var e = seFireVolume;
    setTimeout(function () {
        e == seFireVolume ? ga("send", "event", "Volume-Beta", "updated", "Fire volume at " + seFireVolume) : e = seFireVolume
    }, 3e3)
}

function toggleMute() {
    $(".audio-wind").prop("muted", !$(".audio-wind").prop("muted")), $(".audio-fire").prop("muted", !$(".audio-fire").prop("muted")), $(this).toggleClass("muted")
}
...
function getParameterByName(e) {
    ...
    function c(e, t, n, o) {
        if (re.acceptData(e)) {
            var r, i, a = re.expando,
                s = e.nodeType,
                l = s ? re.cache : e,
                u = s ? e[a] : e[a] && a;
            if (u && l[u] && (o || l[u].data) || void 0 !== n || "string" != typeof t) return u || (u = s ? e[a] = Y.pop() || re.guid++ : a), l[u] || (l[u] = s ? {} : {
                toJSON: re.noop
            }), ("object" == typeof t || "function" == typeof t) && (o ? l[u] = re.extend(l[u], t) : l[u].data = re.extend(l[u].data, t)), i = l[u], o || (i.data || (i.data = {}), i = i.data), void 0 !== n && (i[re.camelCase(t)] = n), "string" == typeof t ? (r = i[t], null == r && (r = i[re.camelCase(t)])) : r = i, r
        }
    }
    ...
    function d(e, t, n) {
        if (re.acceptData(e)) {
            var o, r, i = e.nodeType,
                a = i ? re.cache : e,
                s = i ? e[re.expando] : re.expando;
            if (a[s]) {
                if (t && (o = n ? a[s] : a[s].data)) {
                    re.isArray(t) ? t = t.concat(re.map(t, re.camelCase)) : t in o ? t = [t] : (t = re.camelCase(t), t = t in o ? [t] : t.split(" ")), r = t.length;
                    for (; r--;) delete o[t[r]];
                    if (n ? !u(o) : !re.isEmptyObject(o)) return
                }(n || (delete a[s].data, u(a[s]))) && (i ? re.cleanData([e], !0) : ne.deleteExpando || a != a.window ? delete a[s] : a[s] = null)
            }
        }
    }
    ...
    function g(e, t) {
        ...
        if (!i)
            for (i = [], n = e.childNodes || e; null != (o = n[r]); r++) !t || re.nodeName(o, t) ? i.push(o) : re.merge(i, g(o, t));
    ...
    function w(e, t) {
        for (var n, o = 0; null != (n = e[o]); o++) re._data(n, "globalEval", !t || re._data(t[o], "globalEval"))
    }

    function k(e, t) {
        if (1 === t.nodeType && re.hasData(e)) {
            var n, o, r, i = re._data(e),
                a = re._data(t, i),
                s = i.events;
            if (s) {
                delete a.handle, a.events = {};
                for (n in s)
                    for (o = 0, r = s[n].length; r > o; o++) re.event.add(t, n, s[n][o])
            }
    ...
    function T(e, t) {
        ...
        if (1 === t.nodeType) {
            if (n = t.nodeName.toLowerCase(), !ne.noCloneEvent && t[re.expando]) {
                r = re._data(t);
                for (o in r.events) re.removeEvent(t, o, r.handle);
    ...
    function C(t, n) {
        var o, r = re(n.createElement(t)).appendTo(n.body),
            i = e.getDefaultComputedStyle && (o = e.getDefaultComputedStyle(r[0])) ? o.display : re.css(r[0], "display");
        return r.detach(), i
    }
    ...
    function S(e, t) {
        if (t in e) return t;
        for (var n = t.charAt(0).toUpperCase() + t.slice(1), o = t, r = pt.length; r--;)
            if (t = pt[r] + n, t in e) return t;
        return o
    }

    function _(e, t) {
        for (var n, o, r, i = [], a = 0, s = e.length; s > a; a++) o = e[a], o.style && (i[a] = re._data(o, "olddisplay"), n = o.style.display, t ? (i[a] || "none" !== n || (o.style.display = ""), "" === o.style.display && _e(o) && (i[a] = re._data(o, "olddisplay", N(o.nodeName)))) : (r = _e(o), (n && "none" !== n || !r) && re._data(o, "olddisplay", r ? n : re.css(o, "display"))));
    ...
    function j(e, t, n, o, r) {
        for (var i = n === (o ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > i; i += 2) "margin" === n && (a += re.css(e, n + Se[i], !0, r)), o ? ("content" === n && (a -= re.css(e, "padding" + Se[i], !0, r)), "margin" !== n && (a -= re.css(e, "border" + Se[i] + "Width", !0, r))) : (a += re.css(e, "padding" + Se[i], !0, r), "padding" !== n && (a += re.css(e, "border" + Se[i] + "Width", !0, r)));
        return a
    }
    ...
    function D(e, t, n) {
        var o = !0,
            ...
            i = et(e),
            a = ne.boxSizing && "border-box" === re.css(e, "boxSizing", !1, i);
        if (0 >= r || null == r) {
            if (r = tt(e, t, i), (0 > r || null == r) && (r = e.style[t]), ot.test(r)) return r;
            o = a && (ne.boxSizingReliable() || r === e.style[t]), r = parseFloat(r) || 0
        }
        return r + j(e, t, n || (a ? "border" : "content"), o, i) + "px"
    }

    function L(e, t, n, o, r) {
        return new L.prototype.init(e, t, n, o, r)
    }
    ...
    function F(e, t, n) {
        for (var o, r = (bt[t] || []).concat(bt["*"]), i = 0, a = r.length; a > i; i++)
            if (o = r[i].call(n, t, e)) return o
    }

    function $(e, t, n) {
        var o, r, i, a, s, l, u, c, d = this,
            p = {},
            f = e.style,
            h = e.nodeType && _e(e),
            m = re._data(e, "fxshow");
        ...
        })), 1 === e.nodeType && ("height" in t || "width" in t) && (n.overflow = [f.overflow, f.overflowX, f.overflowY], u = re.css(e, "display"), c = "none" === u ? re._data(e, "olddisplay") || N(e.nodeName) : u, "inline" === c && "none" === re.css(e, "float") && (ne.inlineBlockNeedsLayout && "inline" !== N(e.nodeName) ? f.zoom = 1 : f.display = "inline-block")), n.overflow && (f.overflow = "hidden", ne.shrinkWrapBlocks() || d.always(function () {
        ...
        for (o in t)
            if (r = t[o], mt.exec(r)) {
                ...
                p[o] = m && m[o] || re.style(e, o)
            } else u = void 0;
        if (re.isEmptyObject(p)) "inline" === ("none" === u ? N(e.nodeName) : u) && (f.display = u);
        else {
            m ? "hidden" in m && (h = m.hidden) : m = re._data(e, "fxshow", {}), i && (m.hidden = !h), h ? re(e).show() : d.done(function () {
                re(e).hide()
            }), d.done(function () {
                var t;
            ...
            for (o in p) a = F(h ? m[o] : 0, o, d), o in m || (m[o] = a.start, h && (a.end = a.start, a.start = "width" === o || "height" === o ? 1 : 0))
        }
    }
    ...
    function M(e, t) {
        var n, o, r, i, a;
        for (n in e)
            if (o = re.camelCase(n), r = t[o], i = e[n], re.isArray(i) && (r = i[1], i = e[n] = i[0]), n !== o && (e[o] = i, delete e[n]), a = re.cssHooks[o], a && "expand" in a) {
    ...
    function O(e, t, n) {
        var o, r, i = 0,
            ...
            l = function () {
                if (r) return !1;
                for (var t = ft || H(), n = Math.max(0, u.startTime + u.duration - t), o = n / u.duration || 0, i = 1 - o, a = 0, l = u.tweens.length; l > a; a++) u.tweens[a].run(i);
            ...
            c = u.props;
        for (M(c, u.opts.specialEasing); a > i; i++)
            if (o = vt[i].call(u, e, c, u.opts)) return o;
        return re.map(c, F, u), re.isFunction(u.opts.start) && u.opts.start.call(e, u), re.fx.timer(re.extend(l, {
            elem: e,
            anim: u,
            queue: u.opts.queue
    ...
    function I(e, t, n, o) {
        ...
        if (re.isArray(t)) re.each(t, function (t, r) {
            n || Ut.test(e) ? o(e, r) : I(e + "[" + ("object" == typeof r ? t : "") + "]", r, n, o)
        });
        else if (n || "object" !== re.type(t)) o(e, t);
        else
            for (r in t) I(e + "[" + r + "]", t[r], n, o)
    }
    ...
    re.fn = re.prototype = {
        ...
        for ("boolean" == typeof a && (u = a, a = arguments[s] || {}, s++), "object" == typeof a || re.isFunction(a) || (a = {}), s === l && (a = this, s--); l > s; s++)
            if (null != (r = arguments[s]))
                for (o in r) e = a[o], n = r[o], a !== n && (u && n && (re.isPlainObject(n) || (t = re.isArray(n))) ? (t ? (t = !1, i = e && re.isArray(e) ? e : []) : i = e && re.isPlainObject(e) ? e : {}, a[o] = re.extend(u, i, n)) : void 0 !== n && (a[o] = n));
        return a
    }, re.extend({
        ...
        merge: function (e, t) {
            for (var n = +t.length, o = 0, r = e.length; n > o;) e[r++] = t[o++];
            if (n !== n)
                for (; void 0 !== t[o];) e[r++] = t[o++];
            return e.length = r, e
        },
        grep: function (e, t, n) {
            for (var o, r = [], i = 0, a = e.length, s = !n; a > i; i++) o = !t(e[i], i), o !== s && r.push(e[i]);
            return r
        },
        map: function (e, t, o) {
            var r, i = 0,
                ...
                l = [];
            if (s)
                for (; a > i; i++) r = t(e[i], i, o), null != r && l.push(r);
            else
        ...
        proxy: function (e, t) {
            var n, o, r;
            return "string" == typeof t && (r = e[t], t = e, e = r), re.isFunction(e) ? (n = J.call(arguments, 2), o = function () {
    ...
    var ue = function (e) {
        function t(e, t, n, o) {
            var r, i, a, s, l, u, d, f, h, m;
            if ((t ? t.ownerDocument || t : P) !== L && D(t), t = t || L, n = n || [], s = t.nodeType, "string" != typeof e || !e || 1 !== s && 9 !== s && 11 !== s) return n;
            if (!o && q) {
                if (11 !== s && (r = ve.exec(e)))
                    if (a = r[1]) {
                        if (9 === s) {
                    ...
                    if (f = d = B, h = t, m = 1 !== s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                        for (u = N(e), (d = t.getAttribute("id")) ? f = d.replace(xe, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", l = u.length; l--;) u[l] = f + p(u[l]);
        ...
        function f(e, t, n) {
            ...
            return t.first ? function (t, n, i) {
                ...
                if (a) {
                    ...
                    for (; t = t[o];)
                        if (1 === t.nodeType || r) {
                            if (l = t[B] || (t[B] = {}), (s = l[o]) && s[0] === W && s[1] === i) return u[2] = s[2];
        ...
        function y(e, t, n, r, i, a) {
            return r && !r[B] && (r = y(r)), i && !i[B] && (i = y(i, a)), o(function (o, a, s, l) {
                var u, c, d, p = [],
                    ...
                    v = !e || !o && t ? y : g(y, p, e, s, l),
                    b = n ? i || (o ? e : h || r) ? [] : a : v;
                if (n && n(v, b, s, l), r)
                    for (u = g(b, f), r(u, [], s, l), c = u.length; c--;)(d = u[c]) && (b[f[c]] = !(v[f[c]] = d));
                if (o) {
                    if (i || e) {
                        if (i) {
                        ...
                        for (c = b.length; c--;)(d = b[c]) && (u = i ? ee(o, d) : p[c]) > -1 && (o[u] = !(a[u] = d))
                    }
                } else b = g(b === a ? b.splice(h, b.length) : b), i ? i(null, a, b, l) : K.apply(a, b)
            })
        }

        function v(e) {
            for (var t, n, o, r = e.length, i = k.relative[e[0].type], a = i || k.relative[" "], s = i ? 1 : 0, l = f(function (e) {
                    return e === t
                }, a, !0), u = f(function (e) {
                    return ee(t, e) > -1
                }, a, !0), c = [function (e, n, o) {
                    var r = !i && (o || n !== _) || ((t = n).nodeType ? l(e, n, o) : u(e, n, o));
                    return t = null, r
                }]; r > s; s++)
                if (n = k.relative[e[s].type]) c = [f(h(c), n)];
                else {
                    if (n = k.filter[e[s].type].apply(null, e[s].matches), n[B]) {
                        for (o = ++s; r > o && !k.relative[e[o].type]; o++);
                        return y(s > 1 && h(c), s > 1 && p(e.slice(0, s - 1).concat({
                            value: " " === e[s - 2].type ? "*" : ""
                        })).replace(le, "$1"), n, o > s && v(e.slice(s, o)), r > o && v(e = e.slice(o)), r > o && p(e))
                    }
                    c.push(n)
                } return h(c)
        }
            ...
            var r = n.length > 0,
                ...
                a = function (o, a, s, l, u) {
                    var c, d, p, f = 0,
                        ...
                        w = b.length;
                    for (u && (_ = a !== L && a); h !== w && null != (c = b[h]); h++) {
                        if (i && c) {
                            for (d = 0; p = e[d++];)
                                if (p(c, a, s)) {
                                    l.push(c);
                        ...
                        r && ((c = !p && c) && f--, o && m.push(c))
                    }
                    if (f += h, r && h !== f) {
                        for (d = 0; p = n[d++];) p(m, y, a, s);
                        if (o) {
                            if (f > 0)
                                for (; h--;) m[h] || y[h] || (y[h] = G.call(l));
                            y = g(y)
                        }
                        K.apply(l, y), u && !o && y.length > 0 && f + n.length > 1 && t.uniqueSort(l)
                    }
                    return u && (W = x, _ = v), m
                };
            return r ? o(a) : a
        }
        var x, w, k, T, C, N, E, S, _, A, j, D, L, H, q, F, $, M, O, B = "sizzle" + 1 * new Date,
            P = e.document,
            W = 0,
            R = 0,
            z = n(),
        ...
        w = t.support = {}, C = t.isXML = function (e) {
            ...
            return o !== L && 9 === o.nodeType && o.documentElement ? (L = o, H = o.documentElement, n = o.defaultView, n && n !== n.top && (n.addEventListener ? n.addEventListener("unload", Te, !1) : n.attachEvent && n.attachEvent("onunload", Te)), q = !C(o), w.attributes = r(function (e) {
                return e.className = "i", !e.getAttribute("className")
            }), w.getElementsByTagName = r(function (e) {
                return e.appendChild(o.createComment("")), !e.getElementsByTagName("*").length
            }), w.getElementsByClassName = ye.test(o.getElementsByClassName), w.getById = r(function (e) {
            ...
            }, $ = [], F = [], (w.qsa = ye.test(o.querySelectorAll)) && (r(function (e) {
            ...
            })), (w.matchesSelector = ye.test(M = H.matches || H.webkitMatchesSelector || H.mozMatchesSelector || H.oMatchesSelector || H.msMatchesSelector)) && r(function (e) {
                w.disconnectedMatch = M.call(e, "div"), M.call(e, "[s!='']:x"), $.push("!=", ae)
            }), F = F.length && new RegExp(F.join("|")), $ = $.length && new RegExp($.join("|")), t = ye.test(H.compareDocumentPosition), O = t || ye.test(H.contains) ? function (e, t) {
                ...
                return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === o || e.ownerDocument === P && O(P, e) ? -1 : t === o || t.ownerDocument === P && O(P, t) ? 1 : A ? ee(A, e) - ee(A, t) : 0 : 4 & n ? -1 : 1)
            } : function (e, t) {
                if (e === t) return j = !0, 0;
                var n, r = 0,
                    i = e.parentNode,
                    ...
                    l = [e],
                    u = [t];
                if (!i || !s) return e === o ? -1 : t === o ? 1 : i ? -1 : s ? 1 : A ? ee(A, e) - ee(A, t) : 0;
                if (i === s) return a(e, t);
            ...
            if ((e.ownerDocument || e) !== L && D(e), n = n.replace(de, "='$1']"), w.matchesSelector && q && (!$ || !$.test(n)) && (!F || !F.test(n))) try {
                var o = M.call(e, n);
            ...
            var n = k.attrHandle[t.toLowerCase()],
                o = n && Y.call(k.attrHandle, t.toLowerCase()) ? n(e, t, !q) : void 0;
            return void 0 !== o ? o : w.attributes || !q ? e.getAttribute(t) : (o = e.getAttributeNode(t)) && o.specified ? o.value : null
        }, t.error = function (e) {
            ...
            filter: {
                ...
                ATTR: function (e, n, o) {
                    return function (r) {
                        var i = t.attr(r, e);
                        return null == i ? "!=" === n : n ? (i += "", "=" === n ? i === o : "!=" === n ? i !== o : "^=" === n ? o && 0 === i.indexOf(o) : "*=" === n ? o && i.indexOf(o) > -1 : "$=" === n ? o && i.slice(-o.length) === o : "~=" === n ? (" " + i.replace(se, " ") + " ").indexOf(o) > -1 : "|=" === n ? i === o || i.slice(0, o.length + 1) === o + "-" : !1) : !0
                    }
                },
                CHILD: function (e, t, n, o, r) {
                    ...
                    return 1 === o && 0 === r ? function (e) {
                        ...
                        var u, c, d, p, f, h, m = i !== a ? "nextSibling" : "previousSibling",
                            g = t.parentNode,
                        ...
                        if (g) {
                            ...
                            if (h = [a ? g.firstChild : g.lastChild], a && v) {
                                for (c = g[B] || (g[B] = {}), u = c[e] || [], f = u[0] === W && u[1], p = u[0] === W && u[2], d = f && g.childNodes[f]; d = ++f && d && d[m] || (p = f = 0) || h.pop();)
                                ...
                                for (;
                                    (d = ++f && d && d[m] || (p = f = 0) || h.pop()) && ((s ? d.nodeName.toLowerCase() !== y : 1 !== d.nodeType) || !++p || (v && ((d[B] || (d[B] = {}))[e] = [W, p]), d !== t)););
                ...
                PSEUDO: function (e, n) {
                    ...
                    return i[B] ? i(n) : i.length > 1 ? (r = [e, e, "", n], k.setFilters.hasOwnProperty(e.toLowerCase()) ? o(function (e, t) {
        ...
        return d.prototype = k.filters = k.pseudos, k.setFilters = new d, N = t.tokenize = function (e, n) {
            var o, r, i, a, s, l, u, c = I[e + " "];
            if (c) return n ? 0 : c.slice(0);
            for (s = e, l = [], u = k.preFilter; s;) {
                (!o || (r = ue.exec(s))) && (r && (s = s.slice(r[0].length) || s), l.push(i = [])), o = !1, (r = ce.exec(s)) && (o = r.shift(), i.push({
                    value: o,
                    type: r[0].replace(le, " ")
                }), s = s.slice(o.length));
                for (a in k.filter) !(r = he[a].exec(s)) || u[a] && !(r = u[a](r)) || (o = r.shift(), i.push({
                    value: o,
                    type: a,
                    matches: r
                }), s = s.slice(o.length));
            ...
            var n, o = [],
                ...
                i = X[e + " "];
            if (!i) {
                for (t || (t = N(e)), n = t.length; n--;) i = v(t[n]), i[B] ? o.push(i) : r.push(i);
                i = X(e, b(r, o)), i.selector = e
            }
            return i
        }, S = t.select = function (e, t, n, o) {
            var r, i, a, s, l, u = "function" == typeof e && e,
                d = !o && N(e = u.selector || e);
            if (n = n || [], 1 === d.length) {
                if (i = d[0] = d[0].slice(0), i.length > 2 && "ID" === (a = i[0]).type && w.getById && 9 === t.nodeType && q && k.relative[i[1].type]) {
                    if (t = (k.find.ID(a.matches[0].replace(we, ke), t) || [])[0], !t) return n;
                    u && (t = t.parentNode), e = e.slice(i.shift().value.length)
                }
                for (r = he.needsContext.test(e) ? 0 : i.length; r-- && (a = i[r], !k.relative[s = a.type]);)
                    if ((l = k.find[s]) && (o = l(a.matches[0].replace(we, ke), be.test(i[0].type) && c(t.parentNode) || t))) {
                        if (i.splice(r, 1), e = o.length && p(i), !e) return K.apply(n, o), n;
                        break
                    }
            }
            return (u || E(e, d))(o, t, !q, n, be.test(e) && c(t.parentNode) || t), n
        }, w.sortStable = B.split("").sort(V).join("") === B, w.detectDuplicates = !!j, D(), w.sortDetached = r(function (e) {
    ...
    var fe, he = e.document,
        ...
        ge = re.fn.init = function (e, t) {
            ...
            if ("string" == typeof e) {
                ...
                if (o = he.getElementById(n[2]), o && o.parentNode) {
                    if (o.id !== n[2]) return fe.find(e);
    ...
    re.extend({
        dir: function (e, t, n) {
            for (var o = [], r = e[t]; r && 9 !== r.nodeType && (void 0 === n || 1 !== r.nodeType || !re(r).is(n));) 1 === r.nodeType && o.push(r), r = r[t];
            return o
        },
        ...
        closest: function (e, t) {
            for (var n, o = 0, r = this.length, i = [], a = ce.test(e) || "string" != typeof e ? re(e, t || this.context) : 0; r > o; o++)
        ...
        re.fn[e] = function (n, o) {
            ...
            return "Until" !== e.slice(-5) && (o = n), o && "string" == typeof o && (r = re.filter(o, r)), this.length > 1 && (ve[e] || (r = re.unique(r)), ye.test(e) && (r = r.reverse())), this.pushStack(r)
        }
    });
    var be = /\S+/g,
        xe = {};
    re.Callbacks = function (e) {
        e = "string" == typeof e ? xe[e] || i(e) : re.extend({}, e);
        var t, n, o, r, a, s, l = [],
            u = !e.once && [],
            c = function (i) {
                for (n = e.memory && i, o = !0, a = s || 0, s = 0, r = l.length, t = !0; l && r > a; a++)
            ...
            d = {
                add: function () {
                    if (l) {
                        ...
                        }(arguments), t ? r = l.length : n && (s = o, c(n))
                    }
                    return this
                },
                remove: function () {
                    return l && re.each(arguments, function (e, n) {
                        for (var o;
                            (o = re.inArray(n, l, o)) > -1;) l.splice(o, 1), t && (r >= o && r--, a >= o && a--)
                    }), this
                },
                has: function (e) {
        ...
        Deferred: function (e) {
            var t = [
                        ...
                        return re.Deferred(function (n) {
                            re.each(t, function (t, i) {
                                ...
                                r[i[1]](function () {
                                    ...
                                    e && re.isFunction(e.promise) ? e.promise().done(n.resolve).fail(n.reject).progress(n.notify) : n[i[0] + "With"](this === o ? n.promise() : this, a ? [e] : arguments)
                                })
                            }), e = null
                        }).promise()
                    },
                ...
                r = {};
            return o.pipe = o.then, re.each(t, function (e, i) {
                var a = i[2],
                    s = i[3];
        ...
        when: function (e) {
            var t, n, o, r = 0,
                ...
                u = function (e, n, o) {
                    return function (r) {
                        n[e] = this, o[e] = arguments.length > 1 ? J.call(arguments) : r, o === t ? l.notifyWith(n, o) : --s || l.resolveWith(n, o)
                    }
                };
            if (a > 1)
                for (t = new Array(a), n = new Array(a), o = new Array(a); a > r; r++) i[r] && re.isFunction(i[r].promise) ? i[r].promise().done(u(r, o, i)).fail(l.reject).progress(u(r, n, t)) : --s;
    ...
    re.extend({
        ...
        data: function (e, t) {
            var n, o, r, i = this[0],
                a = i && i.attributes;
            if (void 0 === e) {
                if (this.length && (r = re.data(i), 1 === i.nodeType && !re._data(i, "parsedAttrs"))) {
                    for (n = a.length; n--;) a[n] && (o = a[n].name, 0 === o.indexOf("data-") && (o = re.camelCase(o.slice(5)), l(i, o, r[o])));
                    re._data(i, "parsedAttrs", !0)
                }
                return r
            }
        ...
        queue: function (e, t, n) {
            var o;
            return e ? (t = (t || "fx") + "queue", o = re._data(e, t), n && (!o || re.isArray(n) ? o = re._data(e, t, re.makeArray(n)) : o.push(n)), o || []) : void 0
        },
        ...
        promise: function (e, t) {
            ...
            for ("string" != typeof e && (t = e, e = void 0), e = e || "fx"; a--;) n = re._data(i[a], e + "queueHooks"), n && n.empty && (o++, n.empty.add(s));
    ...
    var Ee = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
        ...
        Ae = re.access = function (e, t, n, o, r, i, a) {
            var s = 0,
                l = e.length,
                u = null == n;
            if ("object" === re.type(n)) {
            ...
            } else if (void 0 !== o && (r = !0, re.isFunction(o) || (a = !0), u && (a ? (t.call(e, o), t = null) : (u = t, t = function (e, t, n) {
    ...
    function () {
        var t, n, o = he.createElement("div");
        for (t in {
                submit: !0,
                change: !0,
                focusin: !0
    ...
    re.event = {
        ...
        add: function (e, t, n, o, r) {
            var i, a, s, l, u, c, d, p, f, h, m, g = re._data(e);
            if (g) {
                for (n.handler && (l = n, n = l.handler, r = l.selector), n.guid || (n.guid = re.guid++), (a = g.events) || (a = g.events = {}), (c = g.handle) || (c = g.handle = function (e) {
                    ...
                    }, c.elem = e), t = (t || "").match(be) || [""], s = t.length; s--;) i = Fe.exec(t[s]) || [], f = m = i[1], h = (i[2] || "").split(".").sort(), f && (u = re.event.special[f] || {}, f = (r ? u.delegateType : u.bindType) || f, u = re.event.special[f] || {}, d = re.extend({
                    type: f,
                    origType: m,
                    data: o,
                    handler: n,
                    ...
                    namespace: h.join(".")
                }, l), (p = a[f]) || (p = a[f] = [], p.delegateCount = 0, u.setup && u.setup.call(e, o, h, c) !== !1 || (e.addEventListener ? e.addEventListener(f, c, !1) : e.attachEvent && e.attachEvent("on" + f, c))), u.add && (u.add.call(e, d), d.handler.guid || (d.handler.guid = n.guid)), r ? p.splice(p.delegateCount++, 0, d) : p.push(d), re.event.global[f] = !0);
                e = null
            }
        },
        remove: function (e, t, n, o, r) {
            var i, a, s, l, u, c, d, p, f, h, m, g = re.hasData(e) && re._data(e);
            if (g && (c = g.events)) {
                for (t = (t || "").match(be) || [""], u = t.length; u--;)
                    if (s = Fe.exec(t[u]) || [], f = m = s[1], h = (s[2] || "").split(".").sort(), f) {
                        for (d = re.event.special[f] || {}, f = (o ? d.delegateType : d.bindType) || f, p = c[f] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = i = p.length; i--;) a = p[i], !r && m !== a.origType || n && n.guid !== a.guid || s && !s.test(a.namespace) || o && o !== a.selector && ("**" !== o || !a.selector) || (p.splice(i, 1), a.selector && p.delegateCount--, d.remove && d.remove.call(e, a));
                        l && !p.length && (d.teardown && d.teardown.call(e, h, g.handle) !== !1 || re.removeEvent(e, f, g.handle), delete c[f])
                    } else
                        for (f in c) re.event.remove(e, f + t[u], n, o, !0);
                re.isEmptyObject(c) && (delete g.handle, re._removeData(e, "events"))
            }
        },
        trigger: function (t, n, o, r) {
            var i, a, s, l, u, c, d, p = [o || he],
                f = te.call(t, "type") ? t.type : t,
                h = te.call(t, "namespace") ? t.namespace.split(".") : [];
            if (s = c = o = o || he, 3 !== o.nodeType && 8 !== o.nodeType && !qe.test(f + re.event.triggered) && (f.indexOf(".") >= 0 && (h = f.split("."), f = h.shift(), h.sort()), a = f.indexOf(":") < 0 && "on" + f, t = t[re.expando] ? t : new re.Event(f, "object" == typeof t && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.namespace_re = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = o), n = null == n ? [t] : re.makeArray(n, [t]), u = re.event.special[f] || {}, r || !u.trigger || u.trigger.apply(o, n) !== !1)) {
                if (!r && !u.noBubble && !re.isWindow(o)) {
                    for (l = u.delegateType || f, qe.test(l + f) || (s = s.parentNode); s; s = s.parentNode) p.push(s), c = s;
                    c === (o.ownerDocument || he) && p.push(c.defaultView || c.parentWindow || e)
                }
                for (d = 0;
                    (s = p[d++]) && !t.isPropagationStopped();) t.type = d > 1 ? l : u.bindType || f, i = (re._data(s, "events") || {})[t.type] && re._data(s, "handle"), i && i.apply(s, n), i = a && s[a], i && i.apply && re.acceptData(s) && (t.result = i.apply(s, n), t.result === !1 && t.preventDefault());
                if (t.type = f, !r && !t.isDefaultPrevented() && (!u._default || u._default.apply(p.pop(), n) === !1) && re.acceptData(o) && a && o[f] && !re.isWindow(o)) {
                    c = o[a], c && (o[a] = null), re.event.triggered = f;
                    try {
                        o[f]()
                    } catch (m) {}
                    re.event.triggered = void 0, c && (o[a] = c)
                }
                return t.result
            }
        },
            ...
            if (s[0] = e, e.delegateTarget = this, !u.preDispatch || u.preDispatch.call(this, e) !== !1) {
                for (a = re.event.handlers.call(this, e, l), t = 0;
                    ...
                    for (e.currentTarget = r.elem, i = 0;
                        (o = r.handlers[i++]) && !e.isImmediatePropagationStopped();)(!e.namespace_re || e.namespace_re.test(o.namespace)) && (e.handleObj = o, e.data = o.data, n = ((re.event.special[o.origType] || {}).handle || o.handler).apply(r.elem, s), void 0 !== n && (e.result = n) === !1 && (e.preventDefault(), e.stopPropagation()));
            ...
            if (s && l.nodeType && (!e.button || "click" !== e.type))
                for (; l != this; l = l.parentNode || this)
                    if (1 === l.nodeType && (l.disabled !== !0 || "click" !== e.type)) {
                        for (r = [], i = 0; s > i; i++) o = t[i], n = o.selector + " ", void 0 === r[n] && (r[n] = o.needsContext ? re(n, this).index(l) >= 0 : re.find(n, this, null, [l]).length), r[n] && r.push(o);
                        r.length && a.push({
                            elem: l,
                            handlers: r
                        })
        ...
        fix: function (e) {
            ...
            var t, n, o, r = e.type,
                i = e,
                a = this.fixHooks[r];
            for (a || (this.fixHooks[r] = a = He.test(r) ? this.mouseHooks : Le.test(r) ? this.keyHooks : {}), o = a.props ? this.props.concat(a.props) : this.props, e = new re.Event(i), t = o.length; t--;) n = o[t], e[n] = i[n];
        ...
        simulate: function (e, t, n, o) {
            ...
            o ? re.event.trigger(r, null, t) : re.event.dispatch.call(t, r), r.isDefaultPrevented() && n.preventDefault()
        }
    }, re.removeEvent = he.removeEventListener ? function (e, t, n) {
        e.removeEventListener && e.removeEventListener(t, n, !1)
    } : function (e, t, n) {
        var o = "on" + t;
        e.detachEvent && (typeof e[o] === Te && (e[o] = null), e.detachEvent(o, n))
        ...
        re.event.special[e] = {
            ...
            handle: function (e) {
                var n, o = this,
                    r = e.relatedTarget,
                    i = e.handleObj;
                return (!r || r !== o && !re.contains(o, r)) && (e.type = i.origType, n = i.handler.apply(this, arguments), e.type = t), n
            }
        }
        ...
        re.event.special[t] = {
            setup: function () {
                var o = this.ownerDocument || this,
                    r = re._data(o, t);
                r || o.addEventListener(e, n, !0), re._data(o, t, (r || 0) + 1)
            },
            teardown: function () {
                var o = this.ownerDocument || this,
                    r = re._data(o, t) - 1;
                r ? re._data(o, t, r) : (o.removeEventListener(e, n, !0), re._removeData(o, t))
            }
        }
    }), re.fn.extend({
        on: function (e, t, n, o, r) {
            ...
            }, o.guid = a.guid || (a.guid = re.guid++)), this.each(function () {
                re.event.add(this, e, o, n, t)
            })
        },
    ...
    Je.optgroup = Je.option, Je.tbody = Je.tfoot = Je.colgroup = Je.caption = Je.thead, Je.th = Je.td, re.extend({
        clone: function (e, t, n) {
            var o, r, i, a, s, l = re.contains(e.ownerDocument, e);
            if (ne.html5Clone || re.isXMLDoc(e) || !Oe.test("<" + e.nodeName + ">") ? i = e.cloneNode(!0) : (Qe.innerHTML = e.outerHTML, Qe.removeChild(i = Qe.firstChild)), !(ne.noCloneEvent && ne.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || re.isXMLDoc(e)))
                for (o = g(i), s = g(e), a = 0; null != (r = s[a]); ++a) o[a] && T(r, o[a]);
            if (t)
                if (n)
                    for (s = s || g(e), o = o || g(i), a = 0; null != (r = s[a]); a++) k(r, o[a]);
                else k(e, i);
            return o = g(i, "script"), o.length > 0 && w(o, !l && g(e, "script")), o = s = r = null, i
        },
        buildFragment: function (e, t, n, o) {
            for (var r, i, a, s, l, u, c, d = e.length, p = m(t), f = [], h = 0; d > h; h++)
                if (i = e[h], i || 0 === i)
                    if ("object" === re.type(i)) re.merge(f, i.nodeType ? [i] : i);
                    else if (ze.test(i)) {
                for (s = s || p.appendChild(t.createElement("div")), l = (We.exec(i) || ["", ""])[1].toLowerCase(), c = Je[l] || Je._default, s.innerHTML = c[1] + i.replace(Pe, "<$1></$2>") + c[2], r = c[0]; r--;) s = s.lastChild;
                if (!ne.leadingWhitespace && Be.test(i) && f.push(t.createTextNode(Be.exec(i)[0])), !ne.tbody)
                    for (i = "table" !== l || Re.test(i) ? "<table>" !== c[1] || Re.test(i) ? 0 : s : s.firstChild, r = i && i.childNodes.length; r--;) re.nodeName(u = i.childNodes[r], "tbody") && !u.childNodes.length && i.removeChild(u);
                for (re.merge(f, s.childNodes), s.textContent = ""; s.firstChild;) s.removeChild(s.firstChild);
                s = p.lastChild
            } else f.push(t.createTextNode(i));
            for (s && p.removeChild(s), ne.appendChecked || re.grep(g(f, "input"), y), h = 0; i = f[h++];)
                if ((!o || -1 === re.inArray(i, o)) && (a = re.contains(i.ownerDocument, i), s = g(p.appendChild(i), "script"), a && w(s), n))
                    for (r = 0; i = s[r++];) Ve.test(i.type || "") && n.push(i);
            return s = null, p
        },
        cleanData: function (e, t) {
            for (var n, o, r, i, a = 0, s = re.expando, l = re.cache, u = ne.deleteExpando, c = re.event.special; null != (n = e[a]); a++)
                if ((t || re.acceptData(n)) && (r = n[s], i = r && l[r])) {
                    if (i.events)
                        for (o in i.events) c[o] ? re.event.remove(n, o) : re.removeEvent(n, o, i.handle);
        ...
        remove: function (e, t) {
            for (var n, o = e ? re.filter(e, this) : this, r = 0; null != (n = o[r]); r++) t || 1 !== n.nodeType || re.cleanData(g(n)), n.parentNode && (t && re.contains(n.ownerDocument, n) && w(g(n, "script")), n.parentNode.removeChild(n));
            return this
        },
        empty: function () {
        ...
        html: function (e) {
            return Ae(this, function (e) {
                ...
                if ("string" == typeof e && !Ie.test(e) && (ne.htmlSerialize || !Oe.test(e)) && (ne.leadingWhitespace || !Be.test(e)) && !Je[(We.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = e.replace(Pe, "<$1></$2>");
                    try {
                        for (; o > n; n++) t = this[n] || {}, 1 === t.nodeType && (re.cleanData(g(t, !1)), t.innerHTML = e);
                        t = 0
                    } catch (r) {}
                }
        ...
        domManip: function (e, t) {
            ...
            if (u && (s = re.buildFragment(e, this[0].ownerDocument, !1, this), n = s.firstChild, 1 === s.childNodes.length && (s = n), n)) {
                for (i = re.map(g(s, "script"), b), r = i.length; u > l; l++) o = s, l !== d && (o = re.clone(o, !0, !0), r && re.merge(i, g(o, "script"))), t.call(this[l], o, l);
                if (r)
                    for (a = i[i.length - 1].ownerDocument, re.map(i, x), l = 0; r > l; l++) o = i[l], Ve.test(o.type || "") && !re._data(o, "globalEval") && re.contains(a, o) && (o.src ? re._evalUrl && re._evalUrl(o.src) : re.globalEval((o.text || o.textContent || o.innerHTML || "").replace(Ye, "")));
                s = n = null
            }
            return this
        }
        ...
        re.fn[e] = function (e) {
            for (var n, o = 0, r = [], i = re(e), a = i.length - 1; a >= o; o++) n = o === a ? this : this.clone(!0), re(i[o])[t](n), Q.apply(r, n.get());
    ...
    e.getComputedStyle ? (et = function (t) {
            ...
            return n = n || et(e), a = n ? n.getPropertyValue(t) || n[t] : void 0, n && ("" !== a || re.contains(e.ownerDocument, e) || (a = re.style(e, t)), ot.test(a) && nt.test(t) && (o = s.width, r = s.minWidth, i = s.maxWidth, s.minWidth = s.maxWidth = s.width = a, a = n.width, s.width = o, s.minWidth = r, s.maxWidth = i)), void 0 === a ? a : a + ""
        }) : he.documentElement.currentStyle && (et = function (e) {
            return e.currentStyle
        }, tt = function (e, t, n) {
            var o, r, i, a, s = e.style;
            return n = n || et(e), a = n ? n[t] : void 0, null == a && s && s[t] && (a = s[t]), ot.test(a) && !rt.test(t) && (o = s.left, r = e.runtimeStyle, i = r && r.left, i && (r.left = e.currentStyle.left), s.left = "fontSize" === t ? "1em" : a, a = s.pixelLeft + "px", s.left = o, i && (r.left = i)), void 0 === a ? a : a + "" || "auto"
        }),
        function () {
            function t() {
                var t, n, o, r;
                n = he.getElementsByTagName("body")[0], n && n.style && (t = he.createElement("div"), o = he.createElement("div"), o.style.cssText = "position:absolute;border:0;width:0;height:0;top:0;left:-9999px", n.appendChild(o).appendChild(t), t.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;display:block;margin-top:1%;top:1%;border:1px;padding:1px;width:4px;position:absolute", i = a = !1, l = !0, e.getComputedStyle && (i = "1%" !== (e.getComputedStyle(t, null) || {}).top, a = "4px" === (e.getComputedStyle(t, null) || {
                    width: "4px"
    ...
    re.extend({
        ...
        style: function (e, t, n, o) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                var r, i, a, s = re.camelCase(t),
                    l = e.style;
                if (t = re.cssProps[s] || (re.cssProps[s] = S(l, s)), a = re.cssHooks[t] || re.cssHooks[s], void 0 === n) return a && "get" in a && void 0 !== (r = a.get(e, !1, o)) ? r : l[t];
                if (i = typeof n, "string" === i && (r = ut.exec(n)) && (n = (r[1] + 1) * r[2] + parseFloat(re.css(e, t)), i = "number"), null != n && n === n && ("number" !== i || re.cssNumber[s] || (n += "px"), ne.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (l[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, o))))) try {
                    l[t] = n
                } catch (u) {}
            }
        },
        css: function (e, t, n, o) {
            var r, i, a, s = re.camelCase(t);
            return t = re.cssProps[s] || (re.cssProps[s] = S(e.style, s)), a = re.cssHooks[t] || re.cssHooks[s], a && "get" in a && (i = a.get(e, !0, n)), void 0 === i && (i = tt(e, t, o)), "normal" === i && t in dt && (i = dt[t]), "" === n || n ? (r = parseFloat(i), n === !0 || re.isNumeric(r) ? r || 0 : i) : i
        }
        ...
        re.cssHooks[t] = {
            ...
            set: function (e, n, o) {
                var r = o && et(e);
                return A(e, n, o ? j(e, t, o, ne.boxSizing && "border-box" === re.css(e, "boxSizing", !1, r), r) : 0)
            }
        }
        ...
        set: function (e, t) {
            ...
            n.zoom = 1, (t >= 1 || "" === t) && "" === re.trim(i.replace(it, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === t || o && !o.filter) || (n.filter = it.test(i) ? i.replace(it, r) : i + " " + r)
        }
        ...
        re.cssHooks[e + t] = {
            expand: function (n) {
                for (var o = 0, r = {}, i = "string" == typeof n ? n.split(" ") : [n]; 4 > o; o++) r[e + Se[o] + t] = i[o] || i[o - 2] || i[0];
                return r
            }
        ...
        css: function (e, t) {
            return Ae(this, function (e, t, n) {
                var o, r, i = {},
                    a = 0;
                if (re.isArray(t)) {
                    for (o = et(e), r = t.length; r > a; a++) i[t[a]] = re.css(e, t[a], !1, o);
                    return i
                }
        ...
        toggle: function (e) {
            return "boolean" == typeof e ? e ? this.show() : this.hide() : this.each(function () {
                _e(this) ? re(this).show() : re(this).hide()
            })
        }
    }), re.Tween = L, L.prototype = {
        constructor: L,
        init: function (e, t, n, o, r, i) {
            this.elem = e, this.prop = n, this.easing = r || "swing", this.options = t, this.start = this.now = this.cur(), this.end = o, this.unit = i || (re.cssNumber[n] ? "" : "px")
        },
        cur: function () {
        ...
        bt = {
            "*": [function (e, t) {
                var n = this.createTween(e, t),
                    ...
                    a = (re.cssNumber[e] || "px" !== i && +o) && gt.exec(re.css(n.elem, e)),
                    s = 1,
                    l = 20;
                if (a && a[3] !== i) {
                    i = i || a[3], r = r || [], a = +o || 1;
                    do s = s || ".5", a /= s, re.style(n.elem, e, a + i); while (s !== (s = n.cur() / o) && 1 !== s && --l)
                }
    ...
    re.Animation = re.extend(O, {
            tweener: function (e, t) {
                ...
                for (var n, o = 0, r = e.length; r > o; o++) n = e[o], bt[n] = bt[n] || [], bt[n].unshift(t)
            },
            ...
            return o.duration = re.fx.off ? 0 : "number" == typeof o.duration ? o.duration : o.duration in re.fx.speeds ? re.fx.speeds[o.duration] : re.fx.speeds._default, (null == o.queue || o.queue === !0) && (o.queue = "fx"), o.old = o.complete, o.complete = function () {
            ...
            stop: function (e, t, n) {
                ...
                return "string" != typeof e && (n = t, t = e, e = void 0), t && e !== !1 && this.queue(e || "fx", []), this.each(function () {
                    ...
                    if (r) a[r] && a[r].stop && o(a[r]);
                        ...
                        for (r in a) a[r] && a[r].stop && yt.test(r) && o(a[r]);
        ...
        function () {
            var e, t, n, o, r;
            t = he.createElement("div"), t.setAttribute("className", "t"), t.innerHTML = "  <link/><table></table><a href='/a'>a</a><input type='checkbox'/>", o = t.getElementsByTagName("a")[0], n = he.createElement("select"), r = n.appendChild(he.createElement("option")), e = t.getElementsByTagName("input")[0], o.style.cssText = "top:1px", ne.getSetAttribute = "t" !== t.className, ne.style = /top/.test(o.getAttribute("style")), ne.hrefNormalized = "/a" === o.getAttribute("href"), ne.checkOn = !!e.value, ne.optSelected = r.selected, ne.enctype = !!he.createElement("form").enctype, n.disabled = !0, ne.optDisabled = !r.disabled, e = he.createElement("input"), e.setAttribute("value", ""), ne.input = "" === e.getAttribute("value"), e.value = "t", e.setAttribute("type", "radio"), ne.radioValue = "t" === e.value
        }();
    var xt = /\r/g;
    re.fn.extend({
        val: function (e) {
            var t, n, o, r = this[0]; {
                if (arguments.length) return o = re.isFunction(e), this.each(function (n) {
                    var r;
                    1 === this.nodeType && (r = o ? e.call(this, n, re(this).val()) : e, null == r ? r = "" : "number" == typeof r ? r += "" : re.isArray(r) && (r = re.map(r, function (e) {
                        return null == e ? "" : e + ""
            ...
            select: {
                get: function (e) {
                    for (var t, n, o = e.options, r = e.selectedIndex, i = "select-one" === e.type || 0 > r, a = i ? null : [], s = i ? r + 1 : o.length, l = 0 > r ? s : i ? r : 0; s > l; l++)
                        if (n = o[l], (n.selected || l === r) && (ne.optDisabled ? !n.disabled : null === n.getAttribute("disabled")) && (!n.parentNode.disabled || !re.nodeName(n.parentNode, "optgroup"))) {
                            if (t = re(n).val(), i) return t;
                            a.push(t)
                        } return a
                },
                set: function (e, t) {
                    for (var n, o, r = e.options, i = re.makeArray(t), a = r.length; a--;)
                        if (o = r[a], re.inArray(re.valHooks.option.get(o), i) >= 0) try {
                            o.selected = n = !0
                        } catch (s) {
                            o.scrollHeight
                        } else o.selected = !1;
    ...
    re.fn.extend({
        ...
        attr: function (e, t, n) {
            var o, r, i = e.nodeType;
            if (e && 3 !== i && 8 !== i && 2 !== i) return typeof e.getAttribute === Te ? re.prop(e, t, n) : (1 === i && re.isXMLDoc(e) || (t = t.toLowerCase(), o = re.attrHooks[t] || (re.expr.match.bool.test(t) ? kt : wt)), void 0 === n ? o && "get" in o && null !== (r = o.get(e, t)) ? r : (r = re.find.attr(e, t), null == r ? void 0 : r) : null !== n ? o && "set" in o && void 0 !== (r = o.set(e, n, t)) ? r : (e.setAttribute(t, n + ""), n) : void re.removeAttr(e, t))
        },
        removeAttr: function (e, t) {
            var n, o, r = 0,
                i = t && t.match(be);
            if (i && 1 === e.nodeType)
                for (; n = i[r++];) o = re.propFix[n] || n, re.expr.match.bool.test(n) ? Et && Nt || !Ct.test(n) ? e[o] = !1 : e[re.camelCase("default-" + n)] = e[o] = !1 : re.attr(e, n, ""), e.removeAttribute(Nt ? n : o)
        },
        attrHooks: {
            type: {
                set: function (e, t) {
        ...
        set: function (e, t, n) {
            return t === !1 ? re.removeAttr(e, n) : Et && Nt || !Ct.test(n) ? e.setAttribute(!Nt && re.propFix[n] || n, n) : e[re.camelCase("default-" + n)] = e[n] = !0, n
        }
    }, re.each(re.expr.match.bool.source.match(/\w+/g), function (e, t) {
        var n = Tt[t] || re.find.attr;
        Tt[t] = Et && Nt || !Ct.test(t) ? function (e, t, o) {
            var r, i;
            return o || (i = Tt[t], Tt[t] = r, r = null != n(e, t, o) ? t.toLowerCase() : null, Tt[t] = i), r
        } : function (e, t, n) {
    ...
    re.fn.extend({
        ...
        prop: function (e, t, n) {
            ...
            if (e && 3 !== a && 8 !== a && 2 !== a) return i = 1 !== a || !re.isXMLDoc(e), i && (t = re.propFix[t] || t, r = re.propHooks[t]), void 0 !== n ? r && "set" in r && void 0 !== (o = r.set(e, n, t)) ? o : e[t] = n : r && "get" in r && null !== (o = r.get(e, t)) ? o : e[t]
        },
        propHooks: {
            tabIndex: {
                get: function (e) {
    ...
    re.fn.extend({
            ...
            if (u)
                for (t = (e || "").match(be) || []; l > s; s++)
                    if (n = this[s], o = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(At, " ") : " ")) {
                        ...
                        a = re.trim(o), n.className !== a && (n.className = a)
                    } return this
        },
            ...
            if (u)
                for (t = (e || "").match(be) || []; l > s; s++)
                    if (n = this[s], o = 1 === n.nodeType && (n.className ? (" " + n.className + " ").replace(At, " ") : "")) {
                        ...
                        a = e ? re.trim(o) : "", n.className !== a && (n.className = a)
                    } return this
        },
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : re.isFunction(e) ? this.each(function (n) {
                ...
                if ("string" === n)
                    for (var t, o = 0, r = re(this), i = e.match(be) || []; t = i[o++];) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
    ...
    re.parseJSON = function (t) {
        ...
        var n, o = null,
            r = re.trim(t + "");
        return r && !re.trim(r.replace(Lt, function (e, t, r, i) {
    ...
    Ht = Wt.exec(qt.toLowerCase()) || [], re.extend({
        active: 0,
        lastModified: {},
        etag: {},
        ajaxSettings: {
        ...
        re[t] = function (e, n, o, r) {
            return re.isFunction(n) && (r = r || o, o = n, n = void 0), re.ajax({
                url: e,
                type: t,
                dataType: r,
                data: n,
    ...
    re.param = function (e, t) {
        ...
        serializeArray: function () {
            return this.map(function () {
                ...
                var e = this.type;
                return this.name && !re(this).is(":disabled") && Gt.test(this.nodeName) && !Jt.test(e) && (this.checked || !je.test(e))
            }).map(function (e, t) {
                var n = re(this).val();
                ...
                send: function (n, o) {
                    ...
                    i.send(e.hasContent && e.data || null), t = function (n, r) {
                        ...
                        if (t && (r || 4 === i.readyState))
                            if (delete Kt[a], t = void 0, i.onreadystatechange = re.noop, r) 4 !== i.readyState && i.abort();
                            else {
                            ...
                            } u && o(s, l, u, i.getAllResponseHeaders())
    ...
    re.ajaxSetup({
        ...
        var r, i, a, s = t.jsonp !== !1 && (tn.test(t.url) ? "url" : "string" == typeof t.data && !(t.contentType || "").indexOf("application/x-www-form-urlencoded") && tn.test(t.data) && "data");
        return s || "jsonp" === t.dataTypes[0] ? (r = t.jsonpCallback = re.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback, s ? t[s] = t[s].replace(tn, "$1" + r) : t.jsonp !== !1 && (t.url += (Dt.test(t.url) ? "&" : "?") + t.jsonp + "=" + r), t.converters["script json"] = function () {
            ...
            e[r] = i, t[r] && (t.jsonpCallback = n.jsonpCallback, en.push(r)), a && re.isFunction(i) && i(a[0]), a = i = void 0
        }), "script") : void 0
        ...
        var o = de.exec(e),
            r = !n && [];
        return o ? [t.createElement(o[1])] : (o = re.buildFragment([e], t, r), r && r.length && re(r).remove(), re.merge([], o.childNodes))
    };
    var nn = re.fn.load;
    re.fn.load = function (e, t, n) {
        ...
        var o, r, i, a = this,
            s = e.indexOf(" ");
        return s >= 0 && (o = re.trim(e.slice(s, e.length)), e = e.slice(0, s)), re.isFunction(t) ? (n = t, t = void 0) : t && "object" == typeof t && (i = "POST"), a.length > 0 && re.ajax({
            url: e,
            type: i,
            dataType: "html",
            data: t
    ...
    re.offset = {
        setOffset: function (e, t, n) {
            var o, r, i, a, s, l, u, c = re.css(e, "position"),
                d = re(e),
                p = {};
            "static" === c && (e.style.position = "relative"), s = d.offset(), i = re.css(e, "top"), l = re.css(e, "left"), u = ("absolute" === c || "fixed" === c) && re.inArray("auto", [i, l]) > -1, u ? (o = d.position(), a = o.top, r = o.left) : (a = parseFloat(i) || 0, r = parseFloat(l) || 0), re.isFunction(t) && (t = t.call(e, n, s)), null != t.top && (p.top = t.top - s.top + a), null != t.left && (p.left = t.left - s.left + r), "using" in t ? t.using.call(e, p) : d.css(p)
        }
    }, re.fn.extend({
        offset: function (e) {
            ...
            var t, n, o = {
                ...
                r = this[0],
                i = r && r.ownerDocument;
            if (i) return t = i.documentElement, re.contains(t, r) ? (typeof r.getBoundingClientRect !== Te && (o = r.getBoundingClientRect()), n = U(i), {
        ...
        position: function () {
            if (this[0]) {
                var e, t, n = {
                    ...
                    o = this[0];
                return "fixed" === re.css(o, "position") ? t = o.getBoundingClientRect() : (e = this.offsetParent(), t = this.offset(), re.nodeName(e[0], "html") || (n = e.offset()), n.top += re.css(e[0], "borderTopWidth", !0), n.left += re.css(e[0], "borderLeftWidth", !0)), {
                    top: t.top - n.top - re.css(o, "marginTop", !0),
                    left: t.left - n.left - re.css(o, "marginLeft", !0)
                }
            }
        },
        offsetParent: function () {
            return this.map(function () {
                for (var e = this.offsetParent || on; e && !re.nodeName(e, "html") && "static" === re.css(e, "position");) e = e.offsetParent;
                return e || on
            })
        }
    }), re.each({
        ...
        var n = /Y/.test(t);
        re.fn[e] = function (o) {
            return Ae(this, function (e, o, r) {
                var i = U(e);
                return void 0 === r ? i ? t in i ? i[t] : i.document.documentElement[o] : e[o] : void(i ? i.scrollTo(n ? re(i).scrollLeft() : r, n ? r : re(i).scrollTop()) : e[o] = r)
            }, e, o, arguments.length, null)
        }
    }), re.each(["top", "left"], function (e, t) {
        re.cssHooks[t] = E(ne.pixelPosition, function (e, n) {
            return n ? (n = tt(e, t), ot.test(n) ? re(e).position()[t] + "px" : n) : void 0
        })
    }), re.each({
        Height: "height",
        Width: "width"
        ...
        re.each({
            ...
            re.fn[o] = function (o, r) {
                ...
                return Ae(this, function (t, n, o) {
                    var r;
                    return re.isWindow(t) ? t.document.documentElement["client" + e] : 9 === t.nodeType ? (r = t.documentElement, Math.max(t.body["scroll" + e], r["scroll" + e], t.body["offset" + e], r["offset" + e], r["client" + e])) : void 0 === o ? re.css(t, n, a) : re.style(t, n, o, a)
                }, t, i ? o : void 0, i, null)
            }
        })
    }), re.fn.size = function () {
    ...
    return re.noConflict = function (t) {
        return e.$ === re && (e.$ = an), t && e.jQuery === re && (e.jQuery = rn), re
    ...
    "classList" in document.documentElement || !Object.defineProperty || "undefined" == typeof HTMLElement || Object.defineProperty(HTMLElement.prototype, "classList", {
        get: function () {
            ...
            return n = function (e) {
                return function (n) {
                    var o, r;
                    o = t.className.split(/\s+/), r = o.indexOf(n), e(o, r, n), t.className = o.join(" ")
                }
            }, t = this, e = {
        ...
        var e;
        return e = encodeURIComponent(this), e.replace(/[!'()*]/g, function (e) {
            return "%" + e.charCodeAt(0).toString(16)
        })
    }, t = function () {
        function e() {}
        return e.prototype.extend = function (e, t, n) {
            var o, r;
            for (r in t) o = void 0 !== e[r], o && "object" == typeof t[r] ? this.extend(e[r], t[r], n) : (n || !o) && (e[r] = t[r])
            ...
            return "undefined" == typeof e || this.is_encoded(e) ? e : e.to_rfc3986()
        }, e.prototype.popup = function (e, t) {
            var n, o, r, i;
            return null == t && (t = {}), o = {
                width: 500,
                height: 350
            }, o.top = screen.height / 2 - o.height / 2, o.left = screen.width / 2 - o.width / 2, r = function () {
                var e;
                e = [];
                for (n in t) i = t[n], e.push("" + n + "=" + this.encode(i));
                return e
            }.call(this).join("&"), r && (r = "?" + r), window.open(e + r, "targetWindow", "toolbar=no,location=no,status=no,menubar=no,scrollbars=yes,resizable=yes,left=" + o.left + ",top=" + o.top + ",width=" + o.width + ",height=" + o.height)
        }, e
    }();
    ...
    return n = function (t) {
        function n(e, t) {
            ...
            return this.element = e, this.el = {
                ...
                caption: null,
                title: (n = document.querySelector('meta[property="og:title"]') || document.querySelector('meta[name="twitter:title"]')) ? n.getAttribute("content") : (n = document.querySelector("title")) ? n.innerText : void 0,
                image: (n = document.querySelector('meta[property="og:image"]') || document.querySelector('meta[name="twitter:image"]')) ? n.getAttribute("content") : void 0,
        ...
        return r(n, t), n.prototype.setup = function (e, t) {
            var n, o, r, i, a;
            for (r = document.querySelectorAll(e), this.extend(this.config, t, !0), this.set_global_configuration(), this.normalize_network_configuration(), this.config.ui.icon_font && this.inject_icons(), this.config.ui.button_font && this.inject_fonts(), this.config.networks.facebook.enabled && this.config.networks.facebook.load_sdk && this.inject_facebook_sdk(), n = i = 0, a = r.length; a > i; n = ++i) o = r[n], this.setup_instance(e, n)
        }, n.prototype.setup_instance = function (e, t) {
            var n, o, r, i, a, s, l, u, c = this;
            for (o = document.querySelectorAll(e)[t], this.hide(o), this.add_class(o, "sharer-" + t), o = document.querySelectorAll(e)[t], this.inject_css(o), this.inject_html(o), this.show(o), r = o.getElementsByTagName("label")[0], n = o.getElementsByClassName("social")[0], a = o.getElementsByTagName("li"), this.add_class(n, "networks-" + this.config.enabled_networks), r.addEventListener("click", function () {
                    return c.event_toggle(n)
                }), c = this, u = [], t = s = 0, l = a.length; l > s; t = ++s) i = a[t], u.push(i.addEventListener("click", function () {
                return c.event_network(o, this), c.event_close(n)
            }));
            return u
        }, n.prototype.event_toggle = function (e) {
            return this.has_class(e, "active") ? this.event_close(e) : this.event_open(e)
        }, n.prototype.event_open = function (e) {
            return this.has_class(e, "load") && this.remove_class(e, "load"), this.add_class(e, "active")
        }, n.prototype.event_close = function (e) {
            return this.remove_class(e, "active")
        }, n.prototype.event_network = function (e, t) {
            var n;
            return n = t.getAttribute("data-network"), this.hook("before", n, e), this["network_" + n](), this.hook("after", n, e)
            ...
            var t, n, o, r, i, a, s;
            for (a = document.querySelectorAll(this.element), s = [], n = r = 0, i = a.length; i > r; n = ++r) o = a[n], t = o.getElementsByClassName("social")[0], s.push(this["event_" + e](t));
            return s
        ...
        // n.prototype.inject_icons = function () {
        //     return this.inject_stylesheet("https://www.sharebutton.co/fonts/v2/entypo.min.css")
        // }, 
        n.prototype.inject_fonts = function () {
            return this.inject_stylesheet("http://fonts.googleapis.com/css?family=Lato:900&text=" + this.config.ui.button_text)
        }, n.prototype.inject_stylesheet = function (e) {
            var t;
            return this.el.head.querySelector('link[href="' + e + '"]') ? void 0 : (t = document.createElement("link"), t.setAttribute("rel", "stylesheet"), t.setAttribute("href", e), this.el.head.appendChild(t))
        }, n.prototype.inject_css = function (t) {
            var n, o, r, i;
            return r = "." + t.getAttribute("class").split(" ").join("."), this.el.head.querySelector("meta[name='sharer" + r + "']") ? void 0 : (this.config.selector = r, n = e(this.config), i = document.createElement("style"), i.type = "text/css", i.styleSheet ? i.styleSheet.cssText = n : i.appendChild(document.createTextNode(n)), this.el.head.appendChild(i), delete this.config.selector, o = document.createElement("meta"), o.setAttribute("name", "sharer" + r), this.el.head.appendChild(o))
        }, 
        // n.prototype.inject_html = function (e) {
        //     return e.innerHTML = "<label class='entypo-export'><span>" + this.config.ui.button_text + "</span></label><div class='social load " + this.config.ui.flyout + "'><ul><li class='entypo-pinterest' data-network='pinterest'></li><li class='entypo-twitter' data-network='twitter'></li><li class='entypo-facebook' data-network='facebook'></li><li class='entypo-gplus' data-network='google_plus'></li><li class='entypo-paper-plane' data-network='email'></li></ul></div>"
        // }, 
        n.prototype.inject_facebook_sdk = function () {
            var e, t;
            ...
            var o, r;
            o = this.config.networks[t][e], "function" == typeof o && (r = o.call(this.config.networks[t], n), void 0 !== r && (r = this.normalize_filter_config_updates(r), this.extend(this.config.networks[t], r, !0), this.normalize_network_configuration()))
        }, n.prototype.set_global_configuration = function () {
            var e, t, n, o, r, i;
            r = this.config.networks, i = [];
            for (t in r) {
                o = r[t];
                for (n in o) null == this.config.networks[t][n] && (this.config.networks[t][n] = this.config[n]);
...
$(document).ready(function () {
    $(".audio-wind").prop("volume", seSnowVolume / 100), $(".audio-fire").prop("volume", seFireVolume / 100)
}), $("a.volume-up-fire").click(volumeUpFire), $("a.volume-down-fire").click(volumeDownFire), $("a.volume-up-wind").click(volumeUpWind), $("a.volume-down-wind").click(volumeDownWind), $("a.mute").click(toggleMute), $(".page").click(function () {
    $("#trigger-menu").attr("checked", !1)
}), watchSnowVolume(), watchFireVolume(), $(window).load(function () {
...
isMobile.any() ? ($("body").addClass("mobile"), $(".audio-wind").trigger("pause").remove(), $(".audio-fire").trigger("pause").remove()) : ($(".audio-wind").trigger("play"), $(".audio-fire").trigger("play"), $(".audio-mobile").trigger("pause"));
var mobileState = 2;
$(".mobile-play").click(function () {
    mobileState % 2 == 0 ? ($(".audio-mobile").trigger("play"), $(this).addClass("playing"), mobileState++, ga("send", "event", "Controls", "play", "mobile-audio")) : ($(this).removeClass("playing"), $(".audio-mobile").trigger("pause"), mobileState++, ga("send", "event", "Controls", "pause", "mobile-audio"))
}), $(".hide-text").click(function () {
    $(".title").toggleClass("hide"), $("footer").toggleClass("hide"), $(".social-share").toggleClass("hide"), $("#btn-menu").toggleClass("shrink"), $(".hide-text").html("Hide Text" == $(".hide-text").text() ? "Show Text" : "Hide Text"), ga("send", "event", "Controls", "toggle", "hide/show text")
}), $("body").keyup(function (e) {
    32 == e.keyCode && $(".mute").trigger("click"), 71 == e.keyCode && ($("video.fire").toggleClass("grayscale"), $(".img-main").toggleClass("grayscale"), ga("send", "event", "Controls", "toggled", "grayscale")), 72 == e.keyCode && $(".hide-text").trigger("click"), 77 == e.keyCode && $("#trigger-menu").trigger("click")
});
var devmode = parseInt(getParameterByName("dev"));
1 == devmode && $("body").addClass("dev");
